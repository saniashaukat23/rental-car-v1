  ...
  return (
    <section className={styles.container}>
      ...
      <h2 className={styles.mainTitle}>
        Secure <span className={styles.blueText}>Payments</span>
      </h2>
      <p className={styles.subtitle}>Multiple payment methods</p>
      <p className={styles.description}>
        Choose from a variety of secure payment options that suit your
        preferences
      </p>
      ...
      <div className={`  ${styles.midBar}`}>
        ...
        <p>
          All payments are secured with <span>SSL encryption</span>
        </p>
      </div>
      <TrustFeatures />
    </section>
